      ...
      <section className="max-w-[1200px] mx-auto px-6 py-40">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-16 items-start">
          ...
          >
            ...
            <p className="text-[var(--color-neuerde-mint)] font-bold uppercase tracking-widest text-xs mb-4">FOUNDER, NEUÉRDE</p>
            <a 
              href="https://www.linkedin.com/in/rachananeurde/" 
              target="_blank" 
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-[var(--color-neuerde-mint)]"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect width="4" height="12" x="2" y="9"/><circle cx="4" cy="4" r="2"/></svg>
