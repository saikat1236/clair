          ...
          <form className="flex flex-col gap-3">
            <div className="flex flex-col gap-2">
              ...
              <input 
                ...
                className="bg-[rgba(255,255,255,0.03)] border border-white/10 rounded-[12px] px-3 py-3 text-[16px] text-white placeholder:text-white/20 focus:outline-none focus:border-[var(--color-clair-mint)]/30 transition-all"
              />
            </div>
            <div className="flex flex-col gap-2">
            ...
            <div className="flex flex-col gap-2">
              ...
              <textarea 
                ...
                className="bg-[rgba(255,255,255,0.03)] border border-white/10 rounded-[12px] px-3 py-3 text-[16px] text-white placeholder:text-white/20 focus:outline-none focus:border-[var(--color-clair-mint)]/30 transition-all resize-none"
              ></textarea>
            </div>
            <button className="bg-[var(--color-clair-mint)] text-[var(--color-clair-dark)] py-3 rounded-full font-bold text-[18px] hover:scale-[1.02] transition-transform shadow-lg shadow-[var(--color-clair-mint)]/10">
              Send Message
            </button>
          </form>
        </motion.div>
